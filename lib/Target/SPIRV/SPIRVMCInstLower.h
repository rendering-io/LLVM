//===-- SPIRVMCInstLower.h - Lower MachineInstr to MCInst -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file declares the class to lower SPIR-V MachineInstrs to
...
public:
  SPIRVMCInstLower(MCContext &ctx, AsmPrinter &printer)
